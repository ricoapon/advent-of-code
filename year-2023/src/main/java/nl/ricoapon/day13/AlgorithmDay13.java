...
import nl.ricoapon.day13.Pattern.Row;
...
public class AlgorithmDay13 implements Algorithm {
    ...
    private int determineReflectionScore(List<Row> rows) {
        ...
        Map<Row, List<Integer>> rowIndexes = new HashMap<>();
    ...
    private boolean isSymmetryLine(List<Row> rows, int symmetry) {
        for (int i = 0; i < rows.size(); i++) {
    ...
    private int determineReflectionScorePart2(List<Row> rows) {
    ...
    private int compareScore(List<Row> rows, int symmetry) {
