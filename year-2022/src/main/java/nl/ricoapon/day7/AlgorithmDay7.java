...
import nl.ricoapon.day7.FileSystem.Directory;
...
public class AlgorithmDay7 implements Algorithm {
            ...
            if (command.startsWith("cd")) {
                ...
                for (String node : nodes) {
                    if (node.startsWith("dir")) {
                        ...
                        int size = Integer.valueOf(node.split(" ")[0]);
    ...
    public String part1(String input) {
        ...
        List<Directory> smallDirectories = fileSystem.getDirectoriesWithSizeAtMost100_000();
    ...
    public String part2(String input) {
        ...
        List<Directory> possibleDirectories = fileSystem.findDirectoriesWithSizeAtLeast(needToFreeUp);

        Directory smallest = possibleDirectories.stream()
            .sorted(Comparator.comparingInt(Directory::getSize))
